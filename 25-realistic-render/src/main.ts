...
directionalLightFolder.add(directionalLight.shadow, 'normalBias').min(-0.05).max(0.05).step(0.001)
directionalLightFolder.add(directionalLight.shadow, 'bias').min(-0.05).max(0.05).step(0.001)
